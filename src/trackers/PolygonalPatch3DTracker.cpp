...
#include <ObjectTracker/trackers/PolygonalPatch3DTracker.h>
...
PolygonalPatch3DTracker::PolygonalPatch3DTracker(TrackerConfig config) :
        AbstractTrackerRst<DataType, STATE_DIMENSIONS>(OBSERVATION_DIMENSIONS, config) {

}

PolygonalPatch3DTracker::~PolygonalPatch3DTracker() {
}

Observations PolygonalPatch3DTracker::makeObservations(DataPtr data) {
...
PolygonalPatch3DTracker::DataPtr PolygonalPatch3DTracker::makeResults(DataPtr data,
